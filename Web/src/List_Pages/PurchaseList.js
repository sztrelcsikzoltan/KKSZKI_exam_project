...
function Purchases() {
    ...
    <Fragment>
		...
		<div className={updatedisplay ? "visible" : "invisible"}><UpdateWindow purchase={purchase} onClose={() => {setUpdateDisplay(false)}}/></div>
		<div className={deletedisplay ? "visible" : "invisible"}><DeleteWindow purchase={purchase} onClose={() => {setDeleteDisplay(false)}}/></div>
    </Fragment>
    )
}
