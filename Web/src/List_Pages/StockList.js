...
function Stocks({currentpage}) {
    ...
    return (
        <Fragment>
		    ...
		    <div className={updatedisplay ? "" : "invisible"}><UpdateWindow stock={stock} onClose={() => {setUpdateDisplay(false)}}/></div>
		    <div className={deletedisplay ? "" : "invisible"}><DeleteWindow stock={stock} onClose={() => {setDeleteDisplay(false)}}/></div>
        </Fragment>
    )
}
