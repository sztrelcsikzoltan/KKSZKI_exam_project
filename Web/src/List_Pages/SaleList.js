...
function Sales({currentpage}) {
    ...
    return (
        <Fragment>
		    ...
		    <div className={updatedisplay ? "" : "invisible"}><UpdateWindow sale={sale} onClose={() => {setUpdateDisplay(false)}}/></div>
		    <div className={deletedisplay ? "" : "invisible"}><DeleteWindow sale={sale} onClose={() => {setDeleteDisplay(false)}}/></div>
        </Fragment>
    )
}
