    ...
    public class User
    {
        ...
        public static List<ServiceReference3.User> GetUsers(string id, string username, string location, string region, string limit)
        {
            ...
            try
            {
                ...
                // if (usersArray == null)
                if (usersArray.Length == 0) // { WPF.NET_Templates.ServiceReference3.User[0]} // TODO: ez jön vissza akkor is, ha elérhető az adatbázis, de üres a lekérés! Módosítani kellene, hogy null értékkel térjen vissza, ha nem tud kapcsolódni az adatbázishoz!
