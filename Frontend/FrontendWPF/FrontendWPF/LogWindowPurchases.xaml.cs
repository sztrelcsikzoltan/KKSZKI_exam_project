        ...
        private void Button_DeletePurchase_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                try
                {
                    ...
                    StreamWriter sw = new StreamWriter("managePurchases.log", append: false, encoding: Encoding.UTF8);
