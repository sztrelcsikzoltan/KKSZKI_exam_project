        ...
        private void Button_DeleteProduct_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                try
                {
                    ...
                    StreamWriter sw = new StreamWriter("manageProducts.log", append: false, encoding: Encoding.UTF8);
