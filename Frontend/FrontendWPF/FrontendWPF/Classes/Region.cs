    ...
    public class Region
    {
        ...
        public static List<LocationService.Region> GetRegions(string id, string location, string region, string limit)
        {
            ...
            try
            {
                ...
                if (regionsArray.Length == 0) // { FrontendWPF.ServiceReference3.Location[0]} // TODO: ez jön vissza akkor is, ha elérhető az adatbázis, de üres a lekérés! Módosítani kellene, hogy null értékkel térjen vissza, ha nem tud kapcsolódni az adatbázishoz!
